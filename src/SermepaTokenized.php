 ...
 */
class SermepaTokenized implements SermepaInterface {
  /**
  ...
  /**
   * Setter for Redsys:DsMerchantIdentifier
   *
   * @param string $merchant_identifier
   *  The value of DsMerchantIdentifier to set.
   *
   * @return Sermepa
   *  Return itself
   *
  ...
  public function setMerchantIdentifier($merchant_identifier) {
    if (strlen($merchant_identifier) > 40) {
      throw new SermepaException('The specified Ds_Merchant_Identifer: ' . $merchant_identifier . ' is too long.', self::BAD_PARAM);
    }

    return $this->set('DsMerchantIdentifier', $merchant_identifier);
  }

  /**
   * Getter for Redsys:DsMerchantIdentifier
   *
   * @return string
   */
